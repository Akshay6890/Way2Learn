...
public class Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Login to Way 2 Learn");
        setBackground(new java.awt.Color(153, 153, 255));
        setBounds(new java.awt.Rectangle(700, 250, 0, 0));
        setResizable(false);

        jLabel2.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel2.setText("Login to Way 2 Learn");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                if(s.equals("Akshay Pendyala") && y.equals("Akshay@1234"))
                {
                    JOptionPane.showMessageDialog(jOptionPane2, "Login Successful");
                    Frame2 f=new Frame2();
                ...
                {
                    JOptionPane.showMessageDialog(jOptionPane2, "Incorrect username or password");
                }
